...
internal enum class KeyItem(val text: String = "", val icon: Int = 0, val value: Int) {
    ...
    TAB("TAB", 0, KeyEvent.KEYCODE_TAB),
    UP("▲", R.mipmap.key_up, KeyEvent.KEYCODE_DPAD_UP),
    DOWN("▼", R.mipmap.key_down, KeyEvent.KEYCODE_DPAD_DOWN),
    LEFT("◀", R.mipmap.key_left, KeyEvent.KEYCODE_DPAD_LEFT),
    RIGHT("▶", R.mipmap.key_right, KeyEvent.KEYCODE_DPAD_RIGHT),
