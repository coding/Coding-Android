 ...
 */
public class BaseAppCompatActivity extends AppCompatActivity implements NetworkCallback,
        StartActivity {
    ...
    protected View.OnClickListener mOnClickUser = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            UserDetailActivity_.intent(BaseAppCompatActivity.this)
                    .globalKey(globalKey)
                    .start();
        }
    };
    ...
    @Override
    public void parseJson(int code, JSONObject respanse, String tag, int pos, Object data) throws
            JSONException {
    }
