...
public class CodingMyPushReceiver extends BroadcastReceiver {

    public static final String PushClickBroadcast = "net.coding.program.CodingMyPushReceiver.PushClickBroadcast";

    public CodingMyPushReceiver() {
    }

    public static void closeNotify(Context context, String url) {
        String notifys[] = CodingPushReciver.sNotify;
